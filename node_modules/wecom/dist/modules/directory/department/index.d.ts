...
import { ICreateDepartment, ICreateDepartmentRet, IDepartmentRet, IUpdateDepartment } from "./interface";
export declare class Department extends Wecom {
     ...
     * @memberof Department
     */
    create(data: ICreateDepartment): Promise<AxiosResponse<ICreateDepartmentRet>>;
    /**
